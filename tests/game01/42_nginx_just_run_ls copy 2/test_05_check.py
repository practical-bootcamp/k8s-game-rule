...
class TestCheck:
    def test_001_check_pod_via_client(self, json_input):
        ...
        assert liveness_probe.period_seconds == 10, "Incorrect periodSeconds for liveness probe."
    ...
    def test_002_check_pod_via_kubectl(self, json_input):
        ...
        assert liveness_probe["periodSeconds"] == 10, "Incorrect periodSeconds for liveness probe."
