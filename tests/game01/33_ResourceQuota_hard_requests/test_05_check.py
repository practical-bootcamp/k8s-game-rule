...
class TestCheck:
    def test_001_check_resourcequota_via_client(self, json_input):
        ...
        try:
            quota = k8s_client.read_namespaced_resource_quota(name=quota_name, namespace=namespace)
        ...
        assert hard_limits["requests.memory"] == "1Gi", "Incorrect requests.memory limit."
        ...
        logging.info(f"ResourceQuota '{quota_name}' in Namespace '{namespace}' has the correct resource requests and limits.")
    ...
    def test_002_check_resourcequota_via_kubectl(self, json_input):
        ...
        logging.info(f"ResourceQuota 'resource-quota' in Namespace 'one' has the correct resource requests and limits.")
