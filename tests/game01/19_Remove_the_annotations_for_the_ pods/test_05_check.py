...
@pytest.mark.order(5)
class TestCheck:
    def test_001_check_no_annotations_with_library(self, json_input):
        ...
        for pod_name in pod_names:
            try:
                ...
                assert annotations == {}, f"Pod '{pod_name}' still has annotations {annotations}"
                logging.info(f"Pod '{pod_name}' has no annotations")
    ...
    def test_002_verify_no_annotations_with_kubectl(self, json_input):
        logging.debug("Starting test_002_verify_no_annotations_with_kubectl")
